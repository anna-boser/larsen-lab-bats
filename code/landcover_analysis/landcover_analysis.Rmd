...
fveg_raster <- rast("~/Documents/github/larsen-lab-bats/data/landcover_analysis/fveg/fveg_ReclassVegCode_NAD83.tif")
```


```{r}
m1 <- cbind(c(10, 20, 31, 32, 41, 42, 51, 52, 60, 70, 80, 90, 100, 200), c(10, 20, 30, 30, 40, 40, 50, 50, 60, 70, 80, 101, 101, 101)) 

fveg_raster_reclass <- classify(fveg_raster, m1)
```
...
fveg_resample_ngb <- terra::resample(fveg_raster_reclass, bat_exp_NAD83, method = "near")
...
st_write(fveg_erase_landIQ, "~/Documents/github/larsen-lab-bats/data/landcover_analysis/output_layers/fveg_erase_landIQ.gpkg", append = F)
...
st_write(fveg_clean_allpolys, "~/Documents/github/larsen-lab-bats/data/landcover_analysis/output_layers/fveg_clean_allpolys.gpkg", append = F)
...
st_write(space_between_fields_allpolys, "~/Documents/github/larsen-lab-bats/data/landcover_analysis/output_layers/space_between_fields_allpolys.gpkg", append = F)
```

```{r}
space_between_fields_allpolys <- st_read("~/Documents/github/larsen-lab-bats/data/landcover_analysis/output_layers/space_between_fields_allpolys.gpkg")
```
...
library(plyr)
space_between_fields_allpolys$NewCode <- mapvalues(space_between_fields_allpolys$values, from = c("10", "20", "30", "40", "50", "60", "70", "80", "101"), to = c("210", "220", "230", "240", "250", "260", "270", "280", "290"))

space_between_fields_allpolys_NewCode <- space_between_fields_allpolys %>% 
  #dplyr::rename(geom = geometry) %>% # if you read in the "space_between_fields_allpolys.gpkg" end result, the name of the 'geometry' column will already be abbreviated as 'geom'. Otherwise you may need to rename the column to match the 'geom' column in the other FVEG and landIQ datasets you'll merge later
...
merged_allpolys_lc_r <- do.call("rbind", list(fveg_clean_allpolys_NewCode, landIQ_allpoly_relabel_NewCode, space_between_fields_allpolys_NewCode))
...
st_write(merged_allpolys_lc_r, "~/Documents/github/larsen-lab-bats/data/landcover_analysis/output_layers/merged_allpolys_lc_r.gpkg", append = F)
```
