...
fveg_WHR10_erase_landIQ <- fveg_WHR10_erase_landIQ %>% 
  rename(LC_ID = fveg_whr10num_ClipBats, geometry=geom)
...
NewCode_map <- data.frame(
  ...
  NewClass = c("Other Agriculture", "Barren/Other", "Conifer", "Desert", "Hardwood", "Herbaceous", "Shrub", "Urban", "Water/Wetland", "Fruits/Nuts/Vineyards", "Row Field", "Grassland", "Rice")
)
